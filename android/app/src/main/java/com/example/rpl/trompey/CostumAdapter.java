...
import com.example.rpl.trompey.R;

import java.util.List;

public class CostumAdapter extends BaseAdapter {
    Context context;
    List<com.example.rpl.trompey.RowItem> rowItems;

    CostumAdapter(Context context, List<com.example.rpl.trompey.RowItem> rowItems) {
