...
public class GroomingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_A:
                Intent A =new Intent(this,DetailsGroomingActivity.class);
                A.putExtra("PAKET", "A");
                ...
                break;
            case R.id.btn_B:
                Intent B =new Intent(this,DetailsGroomingActivity.class);
                B.putExtra("PAKET", "B");
                ...
                break;
            case R.id.btn_C:
                Intent C =new Intent(this,DetailsGroomingActivity.class);
                C.putExtra("PAKET", "C");
